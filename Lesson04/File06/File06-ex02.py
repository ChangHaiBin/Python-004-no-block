...
#    2a. If the user's input cannot be converted into a decimal/float 
#        So, there might be an "exception" or error.
#        print out "Invalid input. Please try again."

#    2b. If the user's input can be converted into a decimal/float, 
#        But the decimal/float is a negative number,
#        print out "You cannot withdraw a negative amount of money"

#    2c. If the user's input can be converted into a decimal/float,
